...
def get_default_config():
    ...
    cfg.test.deid = False # Run de-identification experiment
...
def imagedata_kwargs(cfg):
    return {
        'root': cfg.data.root,
        'root_targets': cfg.data.root_targets,
...
def reset_config(cfg, args):
    ...
    if args.root_targets:
        cfg.data.root_targets = args.root_targets
    if args.sources:
