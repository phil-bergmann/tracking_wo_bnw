...
if __name__ == "__main__":
    ...
    for f_s in frame_skips:
        ...
        for s in train_sequences:
            ...
            det_file_path = os.path.join(data_dir, s, 'det/det.txt')
            ...
            gt_file_path = os.path.join(data_dir, s, 'gt/gt.txt')
            ...
            img_dir = os.path.join(data_dir, s, 'img1')
            ...
            #CONFIG
            shutil.copyfile(os.path.join(data_dir, s, 'seqinfo.ini'),
