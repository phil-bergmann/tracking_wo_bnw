...
def my_main(_config):
    ...
    results_dir = osp.join('track_missed_found')
    ...
    tracker = ["Baseline", "BnW", "FWT", "jCC", "MOTDT", "MHT_DAM"]
    #tracker = tracker[:2]
    ...
    for t in tracker:
        ...
        for s in sequences:
            ...
            res_file = osp.join("../output/tracker/MOT17/plots_track_missed_found", t, s+".txt")
